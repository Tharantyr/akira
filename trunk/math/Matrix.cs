...
namespace Akira.Maths
{
    public class Matrix
    {
        ...
        {
            return new Vector3(
                            m._mat[0, 0] * v.X + m._mat[0, 1] * v.Y + m._mat[0, 2] * v.Z + m._mat[0, 3],
                            m._mat[1, 0] * v.X + m._mat[1, 1] * v.Y + m._mat[1, 2] * v.Z + m._mat[1, 3],
                            m._mat[2, 0] * v.X + m._mat[2, 1] * v.Y + m._mat[2, 2] * v.Z + m._mat[2, 3]);
        }
